...
import com.automationteststore.utils.ExcelUtilss;
...
/**
 * Implements {@link IMethodInterceptor} to leverage the abstract methods
...
public class MethodInterceptor implements IMethodInterceptor {
    ...
    public List<IMethodInstance> intercept(List<IMethodInstance> methods, ITestContext context) {
        ...
        List<Map<String, String>> list = ExcelUtilss.getTestDetails(FrameworkConstants.getRunmangerDatasheet());
