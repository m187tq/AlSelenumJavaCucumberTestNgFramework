...
public class repoData {
    ...
    public final static String GECKO_DRIVER_DIRECTORY = System.getProperty("webWebDrv.getInstance().getWebDriver().gecko.driver",
            "C:/drivers/geckoWebDrv.getInstance().getWebDriver().exe");
    ...
    public final static String HalfCHROME_DRIVER_DIRECTORY = System.setProperty(
            "webWebDrv.getInstance().getWebDriver().chrome.driver", "C:\\drivers\\chromeWebDrv.getInstance().getWebDriver().exe");
    ...
    public static final String LOCAL_DRIVERS_CHROME_DIRECTORY = "C:\\drivers\\chromeWebDrv.getInstance().getWebDriver().exe";
    public static final String LOCAL_DRIVERS_FIREFOX_DIRECTORY = "C:\\drivers\\geckoWebDrv.getInstance().getWebDriver().exe";
    public static final String LOCAL_DRIVERS_IE_DIRECTORY = "C:\\drivers\\IEDriverServer.exe";
    public static final String FIREFOX = "firefox";
    public static final String CHROME = "chrome";
    public static final String IE = "ie";
    public static final String GECKO_DRIVER_KEY = "webWebDrv.getInstance().getWebDriver().gecko.driver";
    public static final String CHROME_DRIVER_KEY = "webWebDrv.getInstance().getWebDriver().chrome.driver";
    public static final String IE_DRIVER_KEY = "webWebDrv.getInstance().getWebDriver().ie.driver";
